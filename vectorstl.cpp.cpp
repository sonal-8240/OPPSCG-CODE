#include <iostream>	
#include <algorithm>	//The STL algorithms are generic because they can
...
{
if(code==i1.code) //operator will return 1 if the comparison is
...
{
if (i1.name != i2.name)
 return i1.cost < i2.cost; //call operator overloaded function <
 
 return i2.cost < i1.cost;
}
